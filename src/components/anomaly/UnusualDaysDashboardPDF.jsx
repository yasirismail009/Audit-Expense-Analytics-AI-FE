...
const UnusualDaysDashboardPDF = ({
  ...
  const handlePrint = () => {
    ...
    var divToPrint = document.getElementById("UnusualDaysDashboardPDF");
    htmlToPrint += divToPrint.outerHTML;

    let newWin = window.open("", "_blank");
    newWin.document.write(htmlToPrint);
    newWin.document.title = "Unusual Days Dashboard Report";
    setTimeout(() => {
      ...
      <div>
        ...
        <div
          ...
          <div className='modal-dialog modal-xl modal-dialog-centered'>
            <div id='UnusualDaysDashboardPDF' className='modal-content'>
              <div className='modal-body bg-white text-dark'>
                <div style={{ padding: "20px" }}>
                  <div className='content-section'>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <h2 style={{ fontWeight: "bold" }}>Unusual Days Dashboard</h2>
                    ...
                    <div className='sections'>
                      <h5 style={{ margin: "20px 0" }}>Unusual Days Dashboard Analysis</h5>
                      ...
                      <div style={{ 
                        ...
                        <p style={{ 
                          ...
                          This dashboard provides comprehensive visual analysis of weekend activity patterns, user distribution, and unusual days transactions.
                        </p>
                      </div>
                      ...
                      {/* Summary Table */}
                      <div className='sections'>
                        <h5 style={{ margin: "10px 0" }}>Dashboard Summary</h5>
                        <table
                          width='100%'
                          border='1'
                          className='border'
...
export default UnusualDaysDashboardPDF; 